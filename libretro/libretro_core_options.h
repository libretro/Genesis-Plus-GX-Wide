...
struct retro_core_option_definition option_defs_us[] = {
   ...
   {
      "genesis_plus_gx_wide_ym2413_core",
      "Master System FM (YM2413) Core",
      "Select which core should be used for the emulation of the Master System FM Sound Unit.",
      {
         { "mame",     "MAME" },
         { "nuked",    "Nuked" },
         { NULL, NULL },
...
#ifdef HAVE_EQ
   {
      "genesis_plus_gx_wide_audio_eq_low",
      "EQ Low",
   ...
   {
      "genesis_plus_gx_wide_audio_eq_mid",
      "EQ Mid",
   ...
   {
      "genesis_plus_gx_wide_audio_eq_high",
      "EQ High",
   ...
   {
      "genesis_plus_gx_wide_widescreen_h40",
      "Force H40 mode to H50 for 16:9",
      "Forces Widescreen Mode. May cause visual glitches and require game-specific patches for the best results.",
      {
         { "disabled", NULL },
         { "enabled",  NULL },
         { NULL, NULL },
      ...
      "Fix 128k DMA Boundary",
      "Fixes a VDP hardware issue with DMA requests crossing 128k boundaries. Recommended to leave disabled, unless specifically required.",
      {
         { "disabled", NULL },
         { "enabled",  NULL },
         { NULL, NULL },
